...
def disable_expired_promotional_schemes():
	...
	try:
		...
		# Note: older versions had a selling_or_buying column, which was removed in newer ERPNext
		# To stay compatible across versions, only select fields we actually use.
